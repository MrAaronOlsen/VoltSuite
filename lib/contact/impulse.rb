    ...
    class Impulse
      class << self
        ...
        def resolve_velocity(manifold, dt)
          ...
          body1.add_rot_impulse(impulse_per_i_mass * body1.i_mass, manifold.contact_points[0])

          body2.add_lin_impulse(impulse_per_i_mass * -1)
          body2.add_rot_impulse(impulse_per_i_mass * -body2.i_mass, manifold.contact_points[0])
        end
        ...
        def resolve_interpenetration(contact, dt)
          ...
          penetration = contact.contact_depth
